    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-nav flex justify-between items-center h-20 px-8 w-full font-['Manrope'] font-semibold">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/login"
            className="bg-surface-container-high px-6 py-2.5 rounded-full text-on-surface font-semibold hover:bg-surface-container-highest transition-colors inline-block cursor-pointer"
          >
            {t('auth.login', 'Login')}
          </Link>
        </div>
