...
export default function AppointmentsPage() {
  ...
  const [bookingDoc, setBookingDoc] = useState<null | { name: string; specialty: string }>(null);
    ...
    <MobileFrame headerTitle="Tele-Consult">
      ...
      <div className="flex flex-col gap-3">
        {filteredDoctors.map((doc, idx) => (
          <div key={idx} className="bg-white rounded-3xl p-4 border border-slate-200 shadow-sm flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setBookingDoc({ name: doc.name, specialty: doc.specialty })}
