...
from routes import triage, referrals, fhw, facility
...
app.include_router(google_fit_auth.router, prefix="/api", tags=["Google Fit Auth"])
app.include_router(drug_checker.router, prefix="/api", tags=["Drug Checker"])
